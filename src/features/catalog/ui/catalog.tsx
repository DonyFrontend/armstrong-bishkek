    ...
    <>
      <div className="bg-black w-full h-full flex justify-center pt-8">
        <div className={`${isMobile ? "w-full" : "w-main"}`}>
          ...
          <div
            className={`flex items-start text-black px-4 mt-4 ${
              isMobile ? "flex-col gap-5" : "justify-between gap-10"
            } `}
          >
            {/* Освещение */}
            <div
              className={`relative ${
                ...
                openLight ? "rounded-t-2xl" : "rounded-2xl"
              } duration-100 p-5 text-black`}
            ...
            >
              ...
              >
                ...
                <span>
                  {openLight ? (
                    <img
                      className="w-6 rotate-180 duration-300 mt-1"
                      src={arrowDown}
                    />
                  ) : (
                    <img className="w-6 duration-300 mt-1" src={arrowDown} />
                  )}
                </span>
              </div>
    ...
    `}
            ...
            <div
              className={`relative ${
                ...
                openCeiling ? "rounded-t-2xl" : "rounded-2xl"
              } duration-100 p-5 text-black`}
  ...
  `}
            ...
            <div
              className={`relative ${
                ...
                openCompound ? "rounded-t-2xl" : "rounded-2xl"
              } duration-100 p-5 text-black`}
  ...
  `}
            ...
            <div
              className={`relative ${
                ...
                openMaterials ? "rounded-t-2xl" : "rounded-2xl"
              } duration-100 p-5 text-black`}
  ...
  `}
          ...
          <div
            className={`w-full mt-8 p-5 ${
              isMobile ? "items-center justify-center flex" : "items-start"
            } `}
          >
            <p className="text-2xl text-white">
              {" "}
              Главная/ <span className="text-[#febc30]"> Каталог </span>{" "}
            </p>
          </div>
